...
hosts = ['apache.im-test.cyberlytic.com']
...
def run_attacks():
    ...
    print(">> Generating {} pieces of {} traffic".format(frequency, mode))
    print(">>> Logging in like a good citizen")

    initialise = populateBhratach('http://{}'.format(hosts[0]))
